    ...
    <main className=" text-ts bg-primary">
      ...
      <section className="min-h-screen p-2 gap-4 max-w-6xl m-auto  mb-16 md:mb-0">
        <motion.div
          ...
          className="text-ts flex mb-10 md:mb-0 justify-center items-center">
        ...
        <div className=" flex  md:flex-row flex-col  p-2  justify-center items-center ">
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, x: 0 }}
            transition={{ ease: "easeIn", delay: 0.8, duration: 0.8 }}
            className="basis-1/2 aspect-square flex justify-center items-center border-accent p-3 rounded-lg ">
            <Image
              className="bg-"
              src={'/1.svg'}
              width={250}
      ...
      <section id="init" className="min-h-screen  p-2  max-w-6xl m-auto flex flex-col justify-evenly items-center mb-16 md:mb-0">
