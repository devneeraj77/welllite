      ...
      <section className="pt-16">
        <div className="max-w-7xl justify-center m-auto rounded-xl border-rose-600 sm:flex sm:border-rose-600 md:border-blue-400 gap-2 lg:w-[70%] lg:flex-1">
          ...
          <div className="basis-2/2 border border-accent md:w-[60%] aspect-square bg-gradient-to-r from-seven rounded-xl m-2 p-2 sm:w-[60%]">
            ...
            >
              <div className="p-2">
                <label htmlFor="name" className="block text-sm text-tp">
                  Name
                </label>
                <input
                  type="text"
              ...
              <div className="p-2">
                <label htmlFor="email" className="block text-sm text-tp">
                  Email
                </label>
                <input
                  type="email"
              ...
              <div className="p-2">
                <label htmlFor="message" className="block text-sm text-tp">
                  Message
                </label>
                <textarea
                  id="message"
